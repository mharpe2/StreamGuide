...
//
//public class Movie : NSManagedObject, CoreDataModelable {
//    
...
//    class func moviesFromResults(results: [[String : AnyObject]], listID: String, context: NSManagedObjectContext?)
//    {
